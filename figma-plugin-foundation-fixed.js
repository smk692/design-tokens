...
// SonMily Design System v1.1.0 (Async 수정판)
// 실행: Figma > Plugins > Development > Run once

const colors = [
  {"name": "Brand/Primary", "hex": "#4A7CF7"},
  {"name": "Brand/Secondary", "hex": "#6B4FBB"},
  {"name": "Brand/Accent", "hex": "#00C9A7"},
  {"name": "Status/Success", "hex": "#40C057"},
  {"name": "Status/Warning", "hex": "#FCC419"},
  {"name": "Status/Danger", "hex": "#FA5252"},
  {"name": "Status/Info", "hex": "#4DABF7"},
  {"name": "AI/Glow Start", "hex": "#4A7CF7"},
  {"name": "AI/Glow End", "hex": "#9C6FFF"},
...
async function main() {
  ...
  frame.x = 0;
  frame.y = 0;
  frame.fills = [{ type: 'SOLID', color: { r: 0.973, g: 0.976, b: 0.980 } }];
  ...
  subtitle.characters = 'BOKHAUS 시니어 케어 | WCAG 2.1 AA | v1.1.0';
  ...
  figma.closePlugin('🎨 Color Foundation 생성 완료! ' + colors.length + '개');
}
